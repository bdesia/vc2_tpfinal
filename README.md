...
1) EDA
2) Modelo #1: Baseline Simple CNN. Salvado en archivo "PDC_baseline.pth".
3) Modelo #2: Baseline Simple CNN with RandAugmentation. Salvado en archivo "PDC_baseline_wRA.pth".
4) Modelo #3: Pre-Trained RESNET 18. Se mantienen congeladas las capas convoluciones y se entrenan solo las cabezas de clasificación (feature extraction approach). Salvado en archivo "PDC_ptRN18.pth".
5) Modelo #4: RESNET18 Fully-trained. Se entran toda la red completamente. Se presenta la matriz de confusión y el classification report. Salvado en archivo "PDC_RN18_ ft.pth".
